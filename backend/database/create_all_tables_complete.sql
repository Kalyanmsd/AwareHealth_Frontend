-- =====================================================
-- COMPLETE DATABASE SETUP FOR AWAREHEALTH
...
-- =====================================================
-- 4. PASSWORD RESET TOKENS TABLE (with OTP support)
-- =====================================================
...
-- Add OTP columns if they don't exist (safe to run multiple times)
...
ADD INDEX IF NOT EXISTS `idx_used` (`used`);
